...
/**
 * @brief 
 * Selects the appropriate Vulkan surface format for the swap chain.
 * 
 * Favors eB8G8R8A8Srgb for the format and eSrgbNonlinear for colorspace.
 */
...
/**
 * @brief
 * Seleects the most appropriate present mode for the swap chain.
 * 
 * Favors FIFO mode.
 *
 * [Vulkan Tutorial]
